...
def train(
    ...
    lora_r: int = 8,
    lora_alpha: int = 16,
    seed: int = 42, # seed for training and data shuffling
    ...
    delta_path: str = None, # whether to subtract the weights of lora to initialize
    # wandb params
    wandb_project: str = "",
    wandb_run_name: str = "",
    ...
    if delta_path:
        ...
        delta_model = PeftModel.from_pretrained(model, delta_path)
        model = delta_model.merge_and_unload()
        del delta_model
        gc.collect()
